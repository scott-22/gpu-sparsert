...
def generate_from_B(Ny_indices, B_indices,BA,block,NY,reg_names, ADDR, GY = None,A_offset=None):
    ...
    for group in range(GY):
        ...
        # NOTE: We aren't guaranteed that B0G0 is always the first block generated by nvcc.
        # I am moving this code to the insert_ptx function
...
def gencode(BA,outfile,C_dim,A_blocks,C_blocks,GY,name=None):
  ...
  #  bounds, NY = load_balancer2(BA)
    ...
    if RESIDUAL or NO_RELU:
        insert_ptx(temp_ptx_file_name, outfile, ptxs, HALF, False)
    else:
        insert_ptx(temp_ptx_file_name, outfile, ptxs, HALF)
